...
[x] Регистрация пользователей (FSM + одобрение администратором)
[x] Валидация ФИО (кириллица, 2–3 слова, с заглавной буквы)
[x] Повторная подача заявки после отклонения
